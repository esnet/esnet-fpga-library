# Xilinx HBM (High-Bandwidth Memory)

This library contains logic and associated testcases for implementing applications
making use of the Xilinx HBM memory controller.
