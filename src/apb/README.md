...
This library contains implementations of the Advanced Peripheral Bus (APB) as
defined in the AMBA APB spec:

[https://documentation-service.arm.com/static/60d5b617677cf7536a55c273?token=]
