...
Packet library; Contains implementations of generic interfaces, modules and
verification infrastructure useful for implementing and testing packet applications.
