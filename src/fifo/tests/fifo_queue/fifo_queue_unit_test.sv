...
module fifo_queue_unit_test #(
    ...
    string name = $sformatf("fifo_queue_depth%0d__ut", DEPTH);
    ...
    localparam bit FWFT = 1; // Always true for fifo_queue
    ...
    localparam int __DEPTH = DEPTH + MEM_RD_LATENCY;
...
endmodule : fifo_queue_unit_test
...
`define FIFO_QUEUE_UNIT_TEST(DEPTH)\
  import svunit_pkg::svunit_testcase;\
  svunit_testcase svunit_ut;\
  fifo_queue_unit_test #(DEPTH) test();\
  function void build();\
    test.build();\
...
module fifo_queue_depth1_unit_test;
`FIFO_QUEUE_UNIT_TEST(1)
endmodule

// 3-entry FIFO (small)
module fifo_queue_depth3_unit_test;
`FIFO_QUEUE_UNIT_TEST(3)
endmodule

// 8-entry FIFO (small)
module fifo_queue_depth8_unit_test;
`FIFO_QUEUE_UNIT_TEST(8)
endmodule

// 32-entry FIFO (small)
module fifo_queue_depth32_unit_test;
`FIFO_QUEUE_UNIT_TEST(32)
endmodule

// 385-entry FIFO (medium)
module fifo_queue_depth385_unit_test;
`FIFO_QUEUE_UNIT_TEST(385)
endmodule

// 512-entry FIFO (medium)
module fifo_queue_depth512_unit_test;
`FIFO_QUEUE_UNIT_TEST(512)
endmodule

// 4097-entry FIFO (large)
module fifo_queue_depth4097_unit_test;
`FIFO_QUEUE_UNIT_TEST(4097)
endmodule
