...
# BD files depend on the real refresh sentinel so Make can track freshness.
# Downstream targets (sim, synth products) depend on these BD files and only
# rebuild when the BD specification has actually changed.
$(BD_FILES): $(BD_PROXY_DIR)/.refreshed
...
_bd_synth_sources: $(SYNTH_SOURCES_OBJ)
