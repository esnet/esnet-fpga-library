...
# XCI files depend on the real refresh sentinel so Make can track freshness.
# Downstream targets (sim, synth products) depend on these XCI files and only
# rebuild when the IP specification has actually changed.
$(IP_XCI_FILES): $(IP_XCI_PROXY_DIR)/.refreshed
...
_ip_synth_sources: $(SYNTH_SOURCES_OBJ)
