...
REGIO_GENERATE_SRC_DEFAULT_OPTS = -o $(REGIO_RTL_SRC_OUTPUT_DIR) -g sv
REGIO_GENERATE_HEADERS_DEFAULT_OPTS = -o $(REGIO_VERIF_OUTPUT_DIR)/include -g svh -p $(__COMPONENT_BASE_NAME)_
